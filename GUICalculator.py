...
def on_click(n):
    ...
    def calculate() :
        ...
        number8 = tk.Button(ob, height=2, width=25, borderwidth=2, command=subtract)
        ...
        number12 = tk.Button(ob, height=2, width=25, borderwidth=2, command=multiplication)
        ...
        number14 = tk.Button(ob, height=2, width=25, borderwidth=2, command=division)
